...
#ifndef SelectorParticleRdist_h
#define SelectorParticleRdist_h
...
class SelectorParticleRdist : public TSelector {
public :
   ...
   ClassDef(SelectorParticleRdist,0);
};

#endif

#ifdef SelectorParticleRdist_cxx
void SelectorParticleRdist::Init(TTree *tree)
{
...
Bool_t SelectorParticleRdist::Notify()
{
...
#endif // #ifdef SelectorParticleRdist_cxx
